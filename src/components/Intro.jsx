...
const Intro = () => {
  ...
  const alphabetImages = [
    { char: 'P', src: '/images/main/logo_p.png' },
    { char: 'O', src: '/images/main/logo_o.png' },
    { char: 'R', src: '/images/main/logo_r.png' },
    { char: 'T', src: '/images/main/logo_t.png' },
    { char: 'E', src: '/images/main/logo_e.png' },
    { char: 'R', src: '/images/main/logo_r.png' },
  ];
      ...
      <div className="intro-preloader" ref={preloaderRef}>
        <div className="intro-preloader__logo" ref={logoRef}>
          {alphabetImages.map((item, i) => (
            <img
              className="intro-preloader__char-img" // 클래스명 변경
              key={i}
              src={item.src}
              alt={item.char}
              ref={(el) => (charRefs.current[i] = el)} // 이미지 엘리먼트를 참조
            />
          ))}
        </div>
      </div>

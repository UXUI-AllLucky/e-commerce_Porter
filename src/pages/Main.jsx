        ...
        <div className="home-container">
                ...
                >
                    <SwiperSlide>
                        ...
                        >
                            <div className="hero__content">
                                ...
                                <Link to="/product" className="hero__btn">
                                    SHOP NOW
                                </Link>
                            </div>
                        </div>
                    ...
                    <SwiperSlide>
                        ...
                        >
                            <div className="hero__content">
                                ...
                                <p className="hero__desc">
                                    Elevate your everyday wardrobe with our timeless pieces.
                                </p>
                                <Link to="/product" className="hero__btn">
                                    SHOP NOW
                                </Link>
                    ...
                    <SwiperSlide>
                        <div
                            ...
                            style={{
                                backgroundImage:
                                    'url(https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80)',
                            }}
                        >
                            <div className="hero__content">
                                <h2 className="hero__title">URBAN ESSENTIALS</h2>
                                <p className="hero__desc">
                                    Modern essentials for the urban lifestyle.
                                </p>
                                <Link to="/product" className="hero__btn">
                                    SHOP NOW
                                </Link>
            ...
            <section className="promo-banner">
                <div
                    ...
                    style={{
                        backgroundImage:
                            'url(https://images.unsplash.com/photo-1469334031218-e382a71b716b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80)',
                    }}
                ></div>
                <div className="promo-banner__content inner gsap-fade-up">
                    <h2 className="banner__title">SEASON OFF SALE</h2>
                    <p className="banner__desc">
                        최대 50% 할인된 가격으로 다양한 상품을 만나보세요.
                    </p>
                    <Link to="/sale" className="banner__btn">
                        SHOP NOW
                    </Link>
                </div>
            </section>
